...
<section class="bg-light" style="padding: 30px 0;">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-11" style="padding-top:80px;" align="center">
			<small>Detalle de tu Orden</small>
			</div>
			<div class="col-1" style="padding-top:80px;">
				<a href="/mis-pedidos" class="btn btn-dark btn-sm" >Seguir</a>
			</div>

		</div>
	</div>
</section>
<section class="section" style="padding-top: 20px !important;">
    <div class="container">
    	<style>
