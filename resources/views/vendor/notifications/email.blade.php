               ...
               <tbody>
                  <tr>
                     <td align="center">
                        ...
                        <br><br>
                        <div align="center">
                                          <a href="{{$actionUrl}}" style="background-color:#000;border-radius:5px;color:#ffffff;display:inline-block;font-family:Arial, Helvetica, sans-serif;font-size:12px;font-weight:500;line-height:50px;text-align:center;text-decoration:none;width:200px" target="_blank">Recuperar</a>
                                       </div>
